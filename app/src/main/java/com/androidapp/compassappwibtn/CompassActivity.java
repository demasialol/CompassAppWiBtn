        ...
        listener = new SensorEventListener() {
            ...
            public void onSensorChanged(SensorEvent event) {
                ...
                if(magneticValues != null && accelValues != null){
                    ...
                    SensorManager.getRotationMatrix(R,I,accelValues,magneticValues); //앞 destination 뒤 source
                    float[] values = new float[3]; // Z, X, Y 축
                    SensorManager.getOrientation(R, values); // values[0]만 피한거다
